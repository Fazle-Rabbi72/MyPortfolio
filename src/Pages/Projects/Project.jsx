...
const projects = [
  ...
  },
  {
    ...
    link_frontend_code:"https://github.com/Fazle-Rabbi72/hotel_booking_frontend"
  },
  {
    id: 3,
    ...
    details: "Designed and developed a comprehensive club management platform that streamlines membership handling, executive body management, voting, messaging, blog posts, event management, and activity tracking. The system ensures secure role-based access, automated email notifications, and real-time collaboration for club members. Built using Django REST Framework and SQLite, this project emphasizes security, data integrity, and efficient API design to manage club operations effectively.",
    technology: ["Django REST Framework","Python","React js","JavaScript", "Sqlite", "Tailwind CSS"],
